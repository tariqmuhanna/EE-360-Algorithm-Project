...
public class Permutation {
    ...
    /**
     * Return the next permutation as a p1.Matching object, representing a solution to the Stable
     * p1.Matching problem contained in data.
     *
     * @param data The p1.Matching object containing the problem to solve.
    ...
    /**
     * Return a p1.Matching (StableMarriage candidate) constructed from the int[] generated by
     * getNextPairing().
     *
     * @param data    The p1.Matching object containing the problem to solve.
     * @param pairing The candidate solution as generated by getNextPairing.
     * @return The p1.Matching corresponding to the provided pairing.
     */
