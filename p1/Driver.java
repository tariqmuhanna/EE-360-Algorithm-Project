...
public class Driver {
    ...
    public static void main(String[] args) throws Exception {
        parseArgs(args);
//        System.out.println(new File("3-3-3.in").getAbsolutePath());
    ...
    private static void usage() {
        System.err.println("usage: java p1.Driver [-gh] [-gr] [-b] [-br] <filename>");
...
//        String s = new File("3-10-3.in").getAbsolutePath();
