...
/**
 * A p1.Matching represents a candidate solution to the Stable Marriage problem. A p1.Matching may or may
 * not be stable.
 */
public class Matching {
    ...
    /**
     * p1.Matching information representing the index of hospital a resident is matched to, -1 if not
     * matched.
     *
    ...
    /**
     * Constructs a solution to the stable marriage problem, given the problem as a p1.Matching. Take a
     * p1.Matching which represents the problem data with no solution, and a resident_matching which
     * solves the problem given in data.
     *
     * @param data              The given problem to solve.
     * @param resident_matching The solution to the problem.
     */
    public Matching(Matching data, ArrayList<Integer> resident_matching) {
        this(
                ...
                data.resident_preference,
                data.hospital_slots,
                resident_matching);
    }

    /**
     * Creates a p1.Matching from data which includes an empty solution.
     *
     * @param data The p1.Matching containing the problem to solve.
     */
